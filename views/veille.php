                ...
                <div class="jumbotron">
                    ...
                    <div class="container-fluid">
                        <div class="text-center">
                            <img class="img-fluid" src="../assets/images/dailydev.svg" height="200" width="200" alt="dailydev">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="container-fluid">
                        <div class="text-center">
                            <img class="img-fluid" src="../assets/images/feedly.svg" height="200" width="200" alt="dailydev">
                        </div>
                    </div>
                    <br>
